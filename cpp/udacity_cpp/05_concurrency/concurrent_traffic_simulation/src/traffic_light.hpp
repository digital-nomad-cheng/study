...
// The class shall have the public methods "void waitForGreen()" and 
// "void simulate()" as well as "TrafficLightPhase getCurrentPhase()", where 
...
// the private member _currentPhase which can take "red" or "green" as its value. 
